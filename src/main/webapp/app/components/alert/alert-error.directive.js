(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('pchauvetonherokuApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-pchauvetonherokuApp-error');
                var entityKey = httpResponse.headers('X-pchauvetonherokuApp-params');
                if (errorHeader) {
